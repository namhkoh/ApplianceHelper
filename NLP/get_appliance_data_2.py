...
def boi_save_train_test(target, slots, slot_dict_boi, intent_dict, single = False):
	...
	with open('appliance3\\train', 'w') as f_train, open('appliance3\\test', 'w') as f_test, open('appliance3\\valid','w') as f_valid:
		# Intent number
...
def boi_save_slot_intent(slot_dict_boi, intent_dict):
	...
	# for i in slot_vocab:
	#     print(i)
	f = open('appliance3\\vocab.slot','w')
	...
	f = open('appliance3\\vocab.intent','w')
