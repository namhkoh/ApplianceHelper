...
public class uiVariant5WithMicrowave extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ui_variant5_with_microwave);
...
//                startActivity(new Intent(uiVariant4WithMicrowave.this,Pop.class));
        ...
        if (uiVariant5WithMicrowave.userQuestions.containsKey("Is First")) {
            Log.e("Is First", String.valueOf(uiVariant5WithMicrowave.userQuestions.getBoolean("Is First")));
            load_bundle();
